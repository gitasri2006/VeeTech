...
import { Compass, RefreshCw, Sliders, MessageSquare, LogOut } from 'lucide-react';
  ...
  return (
    <header className="h-16 bg-white/95 border-b border-slate-200 backdrop-blur px-6 flex items-center justify-between sticky top-0 z-50 shadow-sm select-none">
      ...
      <div className="flex items-center space-x-3">
        ...
        {currentUser && (
          <div className="flex items-center space-x-2.5 bg-slate-50 border border-slate-200 rounded-xl px-3 py-1.5 shadow-sm">
